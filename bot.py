...
bot = telebot.TeleBot("6320148381:AAGv3DhPwHV9_KmOV5oC9PHCto6cQd5M808")  # Thay bằng token bot bạn
...
def place_bet(message):
    try:
        ...
        if number < 3 or number > 17:
            return bot.reply_to(message, "Chỉ cược từ 3 đến 17.")
