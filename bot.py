...
# ===== AI DỰ ĐOÁN 3 PHIÊN NÂNG CAO BẰNG XÚC XẮC =====
def ai_predict_next_n_with_faces(n=3, last_n=5, face_n=10):
...
def build_msg(phien, ketqua, tong, x1,x2,x3):
    ...
    predict_ai="\n".join(ai_predict_next_n_with_faces(3))
    prev="Chưa có"
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        "Sunwin TX Bot v4.1\n• /taixiu → Xem kết quả + xu hướng + winrate + AI dự đoán 3 phiên\nBot auto gửi theo phiên mới 🤖"
    )
